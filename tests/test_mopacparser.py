...
def test_spin_pol(parser):
    ...
    assert sec_calc.forces.total.value[1][2].magnitude == approx(-1.0555523514531733e-08)
    ...
    assert sec_calc.eigenvalues[0].energies[0][0][2].magnitude == approx(-2.92861066e-18)
    assert sec_calc.eigenvalues[0].energies[1][0][5].magnitude == approx(-3.26395424e-20)
    assert sec_calc.eigenvalues[0].occupations[0][0][7] == 0.
    assert sec_calc.eigenvalues[0].occupations[1][0][4] == 1.
    assert sec_calc.multipoles[0].dipole.total == 0.
    assert sec_calc.charges[0].value[1].magnitude == approx(9.6130598e-19)
    assert sec_calc.charges[0].orbital_projected[3].value.magnitude == approx(1.64698951e-19)
...
def test_non_spin_pol(parser):
    ...
    assert sec_calc.eigenvalues[0].energies[0][0][4].magnitude == approx(-3.35031637e-18)
    assert sec_calc.eigenvalues[0].occupations[0][0][14] == 2.
    assert sec_calc.charges[0].orbital_projected[24].orbital == 's'
    assert sec_calc.charges[0].orbital_projected[6].value.magnitude == approx(1.61840668e-19)
