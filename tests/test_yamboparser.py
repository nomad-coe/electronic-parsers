...
def test_1(parser):
    archive = EntryArchive()
    parser.parse('tests/data/yambo/hBN/r-10b_1Ry_HF_and_locXC_gw0_em1d_ppa', archive, None)
...
def test_3(parser):
    archive = EntryArchive()
    parser.parse('tests/data/yambo/GaSb/r-02_GW_em1d_ppa_HF_and_locXC_gw0', archive, None)
...
def test_4(parser):
    archive = EntryArchive()
    parser.parse('tests/data/yambo/LiF/r-02_QP_PPA_em1d_ppa_HF_and_locXC_gw0', archive, None)
