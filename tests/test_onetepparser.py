...
def test_scf(parser):
    ...
    assert sec_system[0].atoms.lattice_vectors[2][2].magnitude == approx(1.29648417e-09,)
    ...
    assert sec_scc[0].energy.kinetic_electronic.value.magnitude == approx(1.89937757e-16)
    assert sec_scc[0].energy.correction_hartree.value.magnitude == approx(3.87263469e-16)
    assert sec_scc[0].energy.x_onetep_pseudopotential_local.value.magnitude == approx(-9.80296609e-16)
...
def test_relax(parser):
    ...
    assert sec_scc[0].energy.correction_hartree.value.magnitude == approx(1.08846112e-16)
    assert len(sec_scc[1].scf_iteration) == 9
    assert sec_scc[1].scf_iteration[7].energy.total.value.magnitude == approx(-5.96007361e-17)
...
def test_tddft(parser):
    ...
    assert sec_scc[0].scf_iteration[12].energy.total.value.magnitude == approx(2.60907651e-18)
    assert sec_scc[0].x_onetep_section_tddft[0].x_onetep_section_tddft_excitations[0].x_onetep_tddft_excit_energy.magnitude == approx(1.25314575e-18)
    assert sec_scc[0].x_onetep_section_tddft[0].x_onetep_section_tddft_excitations[1].x_onetep_tddft_excit_oscill_str == approx(0.35891E-02)
    assert sec_scc[0].x_onetep_section_tddft[0].x_onetep_section_tddft_excitations[1].x_onetep_tddft_excit_lifetime.magnitude == approx(8.9651e-08)
