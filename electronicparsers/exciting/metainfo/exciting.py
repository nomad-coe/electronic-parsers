...
class Calculation(runschema.calculation.Calculation):
    ...
    x_exciting_exciton = SubSection(
        sub_section=x_exciting_exciton_calculation.m_def, repeats=False
    )

    x_exciting_epsilon = SubSection(
        sub_section=x_exciting_epsilon_calculation.m_def, repeats=False
    )

    x_exciting_sigma = SubSection(
        sub_section=x_exciting_sigma_calculation.m_def, repeats=False
    )

    x_exciting_loss = SubSection(
        sub_section=x_exciting_loss_calculation.m_def, repeats=False
    )
