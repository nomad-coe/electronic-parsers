...
class x_yambo_dynamic_dielectric_matrix(x_yambo_module):
    ...
    x_yambo_fragment = SubSection(
        sub_section=x_yambo_dynamic_dielectric_matrix_fragment.m_def, repeats=True
    )
...
class Method(runschema.method.Method):
    ...
    x_yambo_dynamic_dielectric_matrix = SubSection(
        sub_section=x_yambo_dynamic_dielectric_matrix.m_def, repeats=True
    )

    x_yambo_local_xc_nonlocal_fock = SubSection(
        sub_section=x_yambo_local_xc_nonlocal_fock.m_def, repeats=True
    )
