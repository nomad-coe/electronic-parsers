...
class x_ocean_bse_parameters(MSection):
    ...
    x_ocean_core_haydock = SubSection(
        sub_section=x_ocean_core_haydock_parameters.m_def, repeats=False
    )

    x_ocean_core_gmres = SubSection(
        sub_section=x_ocean_core_gmres_parameters.m_def, repeats=False
    )
...
class Method(runschema.run.Method):
    ...
    x_ocean_screen = SubSection(
        sub_section=x_ocean_screen_parameters.m_def, repeats=False
    )
